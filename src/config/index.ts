...
const ThresholdSchema = z.object({
  loc_warn: z.number().default(300),
  loc_fail: z.number().default(1000),
  function_loc_warn: z.number().default(40),
  function_loc_fail: z.number().default(100),
  cyclomatic_warn: z.number().default(10),
  cyclomatic_fail: z.number().default(20),
  cognitive_warn: z.number().default(15),
  cognitive_fail: z.number().default(30),
  duplication_warn: z.number().default(0.10),
  duplication_fail: z.number().default(0.25),
  parameter_count_warn: z.number().default(4),
  parameter_count_fail: z.number().default(7),
  coverage_warn: z.number().default(0.70),
  coverage_fail: z.number().default(0.40),
  coupling_fan_out_warn: z.number().default(10),
  coupling_fan_out_fail: z.number().default(20),
  dead_export_warn: z.number().default(5),
  dead_export_fail: z.number().default(15),
});
